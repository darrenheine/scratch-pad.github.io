...
function createStartsWithFilter(startsWith) {
  ...
  return function (string) {
    return string[0].toLowerCase() === lowerCaseStartsWith;
  };
...
function createEndsWithFilter(endsWith) {
  ...
  return function (string) {
    return string[string.length - 1].toLowerCase() === lowerCaseEndsWith;
  };
  // YOUR CODE ABOVE HERE //
}
...
modifyStrings(["alex", "francis", "aaron"], function (string) {
  return string + "!";
});
